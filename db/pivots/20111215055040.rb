# Moves embedded wall_items into their own "events" collection. This means that firstly the worlds will be quicker to fetch, but it also means that it's easier to truncate walls. Walls should be seen as "streams".
